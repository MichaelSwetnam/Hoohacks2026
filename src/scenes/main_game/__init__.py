...
class MainGame(Scene):   
    ...
    def __init__(self, level: int):
        ...
        self.__loading_bar.set_progress(1.0)   # starts full, drains to 0
        self.__time_elapsed = 0.0              # ← new

    def draw(self, screen, events):

        draw_health(screen, self.__player_max_health, self.__enemy_max_health,
                    self.__player_health, self.__enemy_health)
